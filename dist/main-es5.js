(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcApp_helpersBackendTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let BackofficeApiService = class BackofficeApiService {
      ...
      processShipments_GetAll(response) {
        ...
        const responseBlob = response instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpResponse"] ? response.body : response.error instanceof Blob ? response.error : undefined;
        let _headers = {};
        ...
        if (status === 401) {
          ...
          return blobToText(responseBlob).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["mergeMap"])(_responseText => {
            ...
            if (Array.isArray(resultData200)) {
              ...
              for (let item of resultData200) result200.push(ShipmentModel.fromJS(item));
            }
        ...
        if (status === 401) {
          ...
          return blobToText(responseBlob).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["mergeMap"])(_responseText => {
            ...
            if (Array.isArray(resultData200)) {
              ...
              for (let item of resultData200) result200.push(Shipment.fromJS(item));
            }
        ...
        if (status === 401) {
          ...
          return blobToText(responseBlob).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["mergeMap"])(_responseText => {
            ...
            if (Array.isArray(resultData200)) {
              ...
              for (let item of resultData200) result200.push(AdminShipmentsModel.fromJS(item));
            }
      ...
      init(_data) {
        if (_data) {
          ...
          if (Array.isArray(_data["shipments"])) {
            ...
            for (let item of _data["shipments"]) this.shipments.push(Shipment.fromJS(item));
          }
        }
      }
  ...
  /*! exports provided: BACKOFFICE_API_BASE_URL, BackofficeApiService, Exception, AppException, ShipmentModel, ProblemDetails, Shipment, User, CreateShipmentModel, AdminShipmentsModel, UserModel, AuthenticateModel, RegisterModel, UpdateModel, UserFilamentModel, SwaggerException, AuthGuard, ErrorInterceptor, JwtInterceptor */
  ...
  function srcApp_helpersListViewListViewComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".search {\n  padding: 8px;\n  margin: 15px auto;\n  font-size: 14px;\n  display: block;\n  background: transparent;\n  width: 100%;\n  border: none;\n  border-bottom: 1px solid #5985ee;\n}\n\n@media screen and (max-width: 800px) {\n  .desktop-hidden {\n    display: initial;\n  }\n\n  .mobile-hidden {\n    display: none;\n  }\n}\n\n@media screen and (min-width: 800px) {\n  .desktop-hidden {\n    display: none;\n  }\n\n  .mobile-hidden {\n    display: initial;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcApp_servicesAuthenticationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let AuthenticationService = class AuthenticationService {
      ...
      login(model) {
        return this.backoffice.users_Authenticate(model).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(user => {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
      ...
      providers: [{
        ...
        provide: _helpers__WEBPACK_IMPORTED_MODULE_10__["BACKOFFICE_API_BASE_URL"],
        useFactory: () => src_environments_environment__WEBPACK_IMPORTED_MODULE_22__["environment"].apiUrl
      }, {
        provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"],
  ...
  function srcAppHomeProfileProfileComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let ProfileComponent = class ProfileComponent {
      ...
      onSubmit() {
        ...
        this._userService.update(this._authenticationService.currentUserValue.id, this.updatedUser).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["first"])()).subscribe(data => {
  ...
  function srcAppLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let LoginComponent = class LoginComponent {
      ...
      onSubmit() {
        ...
        this.loading = true;
        this.authenticationService.login(this._user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])()).subscribe(data => {
  ...
  function srcAppRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let RegisterComponent = class RegisterComponent {
      ...
      onSubmit() {
        ...
        this._authenticationService.register(this._user).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])()).subscribe(data => {
          this._router.navigate([this.returnUrl]);
        }, error => {
          if (error === 'Bad Request') {
  ...
  function srcAppShipmentShipmentComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let ShipmentComponent = class ShipmentComponent {
      ...
      onSubmit() {
        ...
        this._shipmentService.createShipment(this._shipment).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["first"])()).subscribe(data => {
          this._router.navigate([this.returnUrl]);
        }, error => {
          this.error = error;
          this.loading = false;
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\StratosPalaiologos\source\repos\Pt4r\WebApp\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
